...
# PAGINA PRINCIPAL --> aca podemos usar una pagina html pero para probar si andaba SQLite use solo un mensaje
#@app.route("/")
#def index():
#    return render_template("tabla_sensores_para_editar.html")

#Mensaje para ver si funciona todo
@app.route("/")
def index():
    return "Servidor Flask + SQLite funcionando correctamente"
...
#INSERCION AUTOMATICA DE DATOS DE PRUEBA (solo primera vez = 0) (menor a cuatro inserciones < 4)
@app.route("/cargar_demo")
def cargar_demo():

    if LecturaSensores.query.count() < 4:
        ...
        demo3 = LecturaSensores(
            co2=780,
            co2_corregido=776.10,
            temp=22.50,
            hum=68.40,
            fecha="24/03/2021",
            lugar="Biblioteca",
        ...
        demo4 = LecturaSensores(
            co2=920,
            co2_corregido=915.75,
            temp=26.80,
            hum=72.00,
            fecha="24/03/2021",
            lugar="Secretaria",
    ...
    #inserto los datos de pruebas detallados anteriormente
